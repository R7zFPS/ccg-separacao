    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="card-base p-5 border-l-4 border-marinho-300">
          <Clock className="w-6 h-6 text-marinho-500 mb-2" />
          <p className="text-2xl font-bold text-marinho-900">—</p>
          <p className="text-sm text-marinho-400">Aguardando confirmação</p>
        </div>
        <div className="card-base p-5 border-l-4 border-green-400">
          <CheckCircle className="w-6 h-6 text-green-500 mb-2" />
          <p className="text-2xl font-bold text-marinho-900">—</p>
          <p className="text-sm text-marinho-400">Confirmados</p>
        </div>
        <div className="card-base p-5 border-l-4 border-purple-400">
          <Calendar className="w-6 h-6 text-purple-500 mb-2" />
          <p className="text-2xl font-bold text-marinho-900">—</p>
          <p className="text-sm text-marinho-400">Entregas esta semana</p>
        </div>
      </div>

      <div className="card-base p-6 flex items-center justify-between">
        <div>
          <h2 className="font-semibold text-marinho-900">Agendamentos Pendentes</h2>
