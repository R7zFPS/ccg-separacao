    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-marinho-400 mt-1 text-sm">Entregas de hoje — {hoje}</p>
        </div>
        <button
          onClick={buscar}
      ...
      {!carregando && pendentes > 0 && (
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-marinho-600">Clique para ver sua rota de hoje</p>
          </div>
      ...
      {!erro && (carregando ? (
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            <Truck className="w-6 h-6 text-marinho-500 mb-2" />
            <p className="text-3xl font-bold text-marinho-900">
              {pendentes ?? '—'}
            </p>
            <p className="text-sm text-marinho-400">Pendentes hoje</p>
          </button>
          ...
          <div className="card-base p-5 border-l-4 border-green-400">
            ...
            <p className="text-sm text-marinho-400">Entregues hoje</p>
          </div>
        </div>
      ))}
      ...
      <div className="card-base p-6">
        <div className="flex items-center gap-3 mb-4">
          <div className="p-2.5 bg-marinho-100 rounded-lg">
            <MapPin className="w-5 h-5 text-marinho-600" />
          </div>
          <div>
            <h2 className="font-semibold text-marinho-900">Minha Rota</h2>
