...
const CARDS_RESUMO = [
  { label: 'Abertas',         status: 'aberta',                cor: 'bg-gray-100   text-gray-700',   icone: ClipboardList },
  ...
  { label: 'Agendadas',       status: 'agendamento_realizado', cor: 'bg-blue-100   text-blue-700',   icone: CalendarCheck },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">Gerencie suas solicitações de separação.</p>
        </div>
      ...
      {!carregando && v && v.total_criadas > 0 && (
        <div className="card-base p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-semibold text-gray-900">Minha Performance</h2>
          </div>
          ...
          {taxaConclusao !== null && (
            <div>
              <div className="flex justify-between text-xs text-gray-500 mb-1.5">
                ...
                <span className="font-semibold text-gray-700">{taxaConclusao}%</span>
              </div>
      ...
      <div className="card-base p-5">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-base font-semibold text-gray-900">Últimas Solicitações</h2>
          <button
      ...
      {!erro && (carregando ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-400 text-sm">Nenhuma solicitação ainda.</p>
            <button
