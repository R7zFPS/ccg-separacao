...
const CARDS_KPI = [
  { label: 'Solicitações Abertas',  cor: 'border-marinho-300   bg-marinho-50',    icone: Package },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
        {CARDS_KPI.map(({ label, cor, icone: Icone }) => (
          <div key={label} className={`card-base p-4 border-l-4 ${cor}`}>
            ...
            <p className="text-xl font-bold text-marinho-900">—</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="card-base p-6 flex items-center justify-between">
          <div>
            <h2 className="font-semibold text-marinho-900">Histórico Geral</h2>
            <p className="text-sm text-marinho-400 mt-0.5">
      ...
      <div className="card-base p-6">
        <h2 className="text-base font-semibold text-marinho-900 mb-4">
          Volume de Solicitações — Últimos 30 dias
        </h2>
        <div className="text-center py-10">
          <BarChart2 className="w-10 h-10 text-marinho-200 mx-auto mb-3" />
          <p className="text-marinho-400 text-sm">
