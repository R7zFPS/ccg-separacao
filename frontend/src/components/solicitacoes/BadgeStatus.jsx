...
const CORES_STATUS = {
  aberta:                'bg-gray-100    text-gray-600    border border-gray-300',
  ...
  agendamento_realizado: 'bg-blue-100    text-blue-700    border border-blue-300',
...
export function BadgeStatus({ status, className = '' }) {
  return (
    <span className={`
      ...
      ${CORES_STATUS[status] || 'bg-gray-100 text-gray-600'}
      ${className}
    `}>
